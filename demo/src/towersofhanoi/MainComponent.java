...
public class MainComponent extends JComponent {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("A", X_START + SIDE_GAP - STRING_ADJUST / 5, Y_END + STRING_ADJUST);
        g.drawString("B", X_START + SIDE_GAP + ROD_GAP - STRING_ADJUST / 6, Y_END + STRING_ADJUST);
        g.drawString("C", X_END - SIDE_GAP - STRING_ADJUST / 6, Y_END + STRING_ADJUST);
    }
